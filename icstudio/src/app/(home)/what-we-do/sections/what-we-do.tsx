...
export default function WhatWeDo() {
  ...
  return (
    <section className="w-full py-20 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
      {/* Header with navigation link to Projects page */}
      <div className="flex justify-end mb-12">
        <Link href="/projects" className="text-primary hover:text-primary/80 transition-colors flex items-center">
          <span className="mr-2">查看我们的项目</span>
