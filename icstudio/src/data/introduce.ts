...
export const team: teamInfo[] = [
        {
                quote: "团队创始人",
                name: "MapleCity1314",
                designation: "团队创始人，同时也是团队中的前端开发，主要使用Vue，React，Next.js, TypeScript, TailwindCSS等技术，正在钻研后端相关业务如Redis，MySQL，MongoDB等",
                src: "/teamAvatar/boybaba.webp",
        },
        {
                quote:"后端+运维",
                name:"RobinElysia",
                designation:"精通Java、Python后端开发及其后端架构，Kubernetes、Docker、Linux、各种中间件运维部署，熟悉计算机网络，目前攻读人工智能领域",
                src:"/teamAvatar/qwp.webp"
        },
        {
